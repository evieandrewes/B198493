...
## Hypertension Perscriptions per Drug Across Scotland
...
#Here is the links for Prescriptions from August 2019 and August 2022, as well as data about the names of different Health Boards accross Scotland.
...
#Here we use "str_remove" to remove "NHS " from the filtered total_hypertension_prescriptions Health Boards variable, because they don't have this Prefix in the spatial data.
...
#theme_void() is used to make the plot more clean and simplistic looking.
```

### Plot Results

This plot shows that actually, although hypertension prescriptions in NHS Lothian and NHS Greater Glasgow and Clyde increased the most, they actually increased proportionally population-wise to the rest of Scotland. From 2019 to 2022, there appears to be an increase of almost *2 prescriptions per capita per month*, which is an almost alarming amount. Interestingly, the areas with the highest amount of hypertension prescriptions per capita seem to be less well populated areas. Perhaps, as hypertension is an *age-related disease*, these areas might have aging populations. This would be an interesting next step to explore with the data we already have. Overall, it can be said with some certainty that hypertension prescriptions increased across Scotland over the COVID-19 Pandemic (from August 2019 to August 2022).
