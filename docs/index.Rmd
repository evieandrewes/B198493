---
title: "Impact of the COVID-19 Pandemic on Age-Related Disease Prescriptions Across Scotland"
...
From the 2011 to the 2022 census, there was an additional 80,700 people in Scotland who reported bad or very bad health. This is thought to be due to an *aging population.* As a result, this report will aim to deduce if during the COVID-19 pandemic there was a *significant increase* in prescriptions for age-related diseases across Scotland.

## Hypertension Perscriptions Across Scotland

### First Steps

Some of the most common age-related diseases in Scotland include **cardiovascular disease, hypertension (high blood pressure) and arthritis.**
Before we start exploring perscriptions for these diseases, let's load in our libraries.
...
```{r table 1, c(8, 6), fig.cap = "Table showing Difference in Hypertension Perscriptions in a month from 2019 to 2022 in NHS Lothian and NHS Greater Glasgow and Clyde", message=FALSE, warning=FALSE}
...
From this table, we can see the number of prescriptions in a month for hypertension has increased by **600,000** from August 2019 to August 2022 in NHS Lothian and Greater Glasgow and Clyde alone. This indicates a huge increase in hypertension prescriptions over the COVID-19 pandemic.
